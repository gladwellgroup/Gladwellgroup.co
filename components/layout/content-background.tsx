...
export function ContentBackground({ children }: ContentBackgroundProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Large circle top right - increased 30% */}
      <div 
      ...
      {/* Medium circle left - increased 30% */}
      <div 
      ...
      {/* Large circle bottom center - increased 30% */}
      <div 
      ...
      {/* Small accent circle - increased 30% */}
      <div 
      ...
      {/* Extra large background circle for depth - increased 30% */}
      <div 
      ...
      {/* Small floating circle top left - increased 30% */}
      <div 
      ...
      {/* New: Medium cyan circle bottom right */}
      <div 
      ...
      {/* New: Accent purple circle middle */}
      <div 
      ...
      {/* Subtle gradient overlay for cohesion - lighter */}
      <div 
